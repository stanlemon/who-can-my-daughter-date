  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'no', label: 'No', weight: 0, tags: ['not-lutheran'], color: 'default' },
      ],
      emoji: '⛪',
    },
    {
      ...
      options: [
        ...
        { value: 'no', label: 'No', weight: -5, tags: ['lotr-no'], color: 'orange' },
